...
BEGIN
  IF (SELECT COUNT(*) FROM users) = 0 THEN
    ...
    VALUES
      (v_tenant_id, 'admin@squidjob.com', 'SquidJob Admin', '$2a$10$0RzpUCPK9sDU.Cwxfhd6nu1a.OiJMPg9MaQL36A7p8rnR2hD8kSIm', 'owner', true),
      (v_tenant_id, 'kaustubh@awitmedia.com', 'Kaustubh', '$2a$10$ccafedQugTYfDluArXeXzuui0e1f8TalmEgYko2zYDvGRnttLKIpC', 'owner', false);
